...
const getApiUrl = () => {
  // În producție, folosește variabila de mediu sau fallback la backend-ul Heroku
  if (import.meta.env.PROD) {
    return import.meta.env.VITE_API_URL || 'https://cryptic-coast-64248-eu-2796fcaf3115.herokuapp.com';
  }
